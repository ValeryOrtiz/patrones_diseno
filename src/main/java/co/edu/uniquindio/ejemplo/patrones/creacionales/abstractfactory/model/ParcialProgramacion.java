...
public class ParcialProgramacion implements Examen {
    ...
    public ParcialProgramacion(int duracion, int numeroPreguntas, String fechaExamen, double calificacionMaxima) {
    ...
    public void mostrarTipo() {
        System.out.println("Tipo de examen: Parcial de Programación");
    }
